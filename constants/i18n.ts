...
export const STRINGS = {
  ...
  addressHint: 'اختر موقعك بدقة على الخريطة',
  tapMapHint: 'اضغط على الخريطة لتحديد موقعك',
  useCurrentLocation: 'استخدام موقعي الحالي',
  confirmLocation: 'تأكيد الموقع',
  resolvingAddress: 'جاري تحديد العنوان...',
  selectedLocation: 'الموقع المحدد',
  pinnedLocation: 'موقع مختار على الخريطة',
  locationPermissionDenied: 'إذن الوصول للموقع مرفوض',
